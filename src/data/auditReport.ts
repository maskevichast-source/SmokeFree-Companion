...
export const WHO_HEALTH_MILESTONES: HealthMilestone[] = [
  ...
  },
  {
    ...
    practicalTip: 'Используйте дыхание 4-4-4: 4 сек вдох, 4 сек задержка, 4 сек выдох.',
  ...
  {
    id: 'who-5',
    title: 'Снижение риска внезапного инфаркта',
    category: 'Сердечно-сосудистая',
  ...
  {
    id: 'who-8',
    title: '100% очищение организма от никотина',
  ...
  {
    id: 'who-27',
    title: 'Снижение риска рака шейки матки и мочевого пузыря',
